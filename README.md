...
|----------|--------|-------------|------|
| 🏛️ [City of Melbourne – Automated CX Dashboard](https://github.com/tj-jayasekera/customer-insights-dashboard) | Power BI | My main project during my recent internship at the City of Melbourne. Replaced manual Excel reporting with an automated, cross-department dashboard delivering real-time customer experience and marketing insights. | [View Dashboard](./city-of-melbourne-dashboard) |
